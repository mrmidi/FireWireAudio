...
class XPCManager: ObservableObject {
    ...
    private let logger = Logging.Logger(label: "net.mrmidi.fwa-control.XPCManager")
...
private class XPCNotificationHandler: NSObject, FWAClientNotificationProtocol, NSXPCListenerDelegate {
    ...
    private let logger = Logging.Logger(label: "net.mrmidi.fwa-control.XPCNotificationHandler")
